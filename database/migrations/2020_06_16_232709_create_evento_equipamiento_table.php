...
class CreateEventoEquipamientoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('evento_equipamiento', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('evento_equipamiento');
    }
}
